...
#define SAMPLE_DEVICE_NAME          "ESP_UWB_SERVER"    //The Device Name Characteristics in GAP
...
static const uint8_t spp_adv_data[23] = {
    ...
    0x0F,0x09, 'E', 'S', 'P', '_', 'U', 'W', 'B', '_', 'S', 'E', 'R','V', 'E', 'R'
};
...
static uint8_t  heartbeat_s[9] = {'U','W','B','L','o','c','a','t','e'};
