...
{
  //ESP_LOGI(TAG, "ws2812_handleInterrupt");
...
void ws2812_init(int gpioNum, int length)
{
  strip_length = length;
  ws2812_len = (strip_length * 3) * sizeof(uint8_t);
...
void ws2812_setColors(rgbVal *array)
{
  unsigned int i;
